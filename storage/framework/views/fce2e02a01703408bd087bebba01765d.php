<?php $__env->startSection('content'); ?>
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('lpj-header.store-detail')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
...
unset($__errorArgs, $__bag); ?>" id="bukti_lpj"
                                name="bukti_lpj">
                                ...
                                <td class="d-flex gap-1">
                                    <?php if($lpj_header->submission_flag == 'N'): ?>
                                        <div class="d-flex gap-2">
                                            <a href="<?php echo e(route('lpj-header.edit', $item->id)); ?>" class="btn btn-sm btn-primary">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                            <form action="<?php echo e(route('lpj-header.destroy-detail', $item->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\devi\resources\views/lpj/create-detail.blade.php ENDPATH**/ ?>