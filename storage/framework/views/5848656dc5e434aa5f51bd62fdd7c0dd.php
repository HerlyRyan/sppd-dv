...
<?php endif; ?>
    ...
    <div style="text-align: center;">
        <h3>KUITANSI</h3>
        <small style="color: grey; opacity: 20%;"><?php echo e($no_surat); ?><small>
    </div>
    ...
    <div>
        <table class="w-full" style="margin-bottom: 20px">
            <tr>
                <td valign="top" style="width: 200px">Sudah diterima dari</td>
                <td valign="top">:</td>
                <td valign="top" style="text-transform: uppercase">
                    PEJABAT PEMBUAT KOMITMEN KANTOR REGIONAL VIII BKN
                </td>
            </tr>
            <tr>
                <td valign="top" style="width: 200px">Untuk Pembayaran</td>
                <td valign="top">:</td>
                <td valign="top" style="text-transform: uppercase"><?php echo e($untuk_pembayaran); ?></td>
            </tr>
            <tr>
                <td valign="top" style="width: 200px">Sebesar</td>
                <td valign="top">:</td>
                <td valign="top" style="text-transform: uppercase; font-weight: bold">
                    Rp <?php echo e(number_format($sebesar, 0, ',', '.')); ?> (<?php echo e($terbilang); ?>)
                </td>
            </tr>
        </table>
    </div>
...
<?php /**PATH C:\xampp\htdocs\devi\resources\views/kuitansi.blade.php ENDPATH**/ ?>